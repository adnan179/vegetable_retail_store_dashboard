...
const navLinks = [
    ...
    },
    {
        ...
        link:"/sales",
        icon: salesIcon,
        selectedIcon: salesWhiteIcon,
    },
    {
        title:"Credit",
        link:"/jamalu",
        icon: creditIcon,
        selectedIcon: creditWhiteIcon,
    },
    {
        title:"Customers",
        link:"/customers",
        icon: peopleIcon,
        selectedIcon: peopleWhiteIcon,
    },
    {
        title:"Farmers",
        link:"/farmers",
    ...
    },
    {
        ...
        link:"/vegetables",
        icon: vegetableIcon,
        selectedIcon: vegetableWhiteIcon
    },
    
    {
        ...
        link:"/groups",
        icon: groupIcon,
        selectedIcon: groupWhiteIcon
    },
    {
        title:"Reports",
        link:"/reports",
        icon: reportIcon,
        selectedIcon: reportWhiteIcon
    },
]
const Sidebar = () => {
      ...
      <nav className="flex flex-col p-5 items-center">
        ...
        {navLinks.map((l,idx) => (
            <button 
                ...
                className={`${selected === l.title ? "bg-black text-white":"text-black"} p-2 rounded-md flex flex-col items-center justify-center`}>
                <img src={selected === l.title? l.selectedIcon:l.icon} alt={l.title} className="w-6 h-6"/>

...
const SalesHistory = ({ onClose }) => {
    ...
    useEffect(() => {
        fetch(`${backendURL}/sales/history`)
            .then((res) => res.json())
            .then((data) => {
                setHistory(data);
                    ...
                    filteredHistory.map((record, index) => {
                        ...
                        return (
                            <div key={index} className="p-4 border rounded-lg shadow-md bg-gray-50">
                                <h2 className="text-[16px]">Sales Id: <span className="text-blue-500 font-medium">{record.salesId}</span></h2>
